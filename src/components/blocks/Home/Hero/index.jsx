...
const HomeHeroBlock = () => {
    ...
    return (<>
        ...
        <Layout.Col className="sm:flex-row gap-2 w-full sm:w-auto">
            <Link href="/register">
            <Button className="btn-primary rounded-full btn-lg hover:gap-2 transition-all w-full sm:w-auto">
            ...
            <Link href="/playground">
                <Button className="btn-icon rounded-full btn-lg hover:gap-2 transition-all w-full sm:w-auto">
